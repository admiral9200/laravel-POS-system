	...
	<div class="row">
		<div class="col-sm-2 text-center">
			<div class="row">
				...
				<div class="col-sm-6">
					<a type="button" data-toggle="modal" data-target="#import_purchase_invoice_modal"
...
<div class="modal fade quick_add_product_modal_01" tabindex="-1" role="dialog" aria-labelledby="modalTitle"></div>
