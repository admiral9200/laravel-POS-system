...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/purchases/save-value-to-session', [PurchaseController::class, 'saveValueToSession']);
    Route::get('/purchases/get-value-from-session', [PurchaseController::class, 'getValueFromSession']);



    Route::get('/import_invoice', [InvoiceController::class, 'importInvoice'])->name('import_invoice');
    Route::post('/process-invoice', [InvoiceController::class, 'importPurchaseInvoice'])->name('process_invoice');
    Route::post('/import-purchase-products', [InvoiceController::class, 'importPurchaseProducts']);
    Route::post('/import-purchase-invoice', [InvoiceController::class, 'importPurchaseInvoice']);
    Route::post('/add-invoice-item', [InvoiceController::class, 'addInvoiceItem'])->name('add_invoice_item');
    Route::get('/delelte-invoice-item/{id}', [InvoiceController::class, 'destroy'])->name('delete_invoice_item');
    Route::get('/edit-invoice-item/{id}', [InvoiceController::class, 'edit'])->name('edit_invoice_item');
    Route::put('/update-invoice-item', [InvoiceController::class, 'updateItem'])->name('update_invoice_item');
